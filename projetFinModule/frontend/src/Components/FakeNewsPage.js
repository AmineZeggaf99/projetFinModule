        ...
        return (
            <Layout>
                ...
                <div className="site-layout-background" style={{ padding: 24, minHeight: 380 }}>
                    <h1 style={{textAlign: 'center', padding:'10px 30px'}}>Détection des fausses actualités sur le COVID-19</h1>

                    <Divider plain style={{ width: "100%", fontSize: "20px" }} orientation="left" type="horizontal">
                        Entrer le texte que vous désirez détecter
                    </Divider>                   
                    <TextArea showCount placeholder='Entrer le texte que vous désirez détecter' onChange={(e)=>this.setState({news:e.target.value})} />
                    <Col span={3} style={{ padding:'20px 10px 10px 10px' }}>
                        <Button type="primary" htmlType="submit" style={{ width: "100%",display: 'inline-flex', justifyContent: 'center', alignItems: 'center'}}  onClick={()=>{
                          ...
                          this.setState({loading:false})
                            ...
                            {this.state.loading==false && "Détecter"} {this.state.loading==true && <Spinner size={14}/>}
                        </Button>
                    </Col>
                    <Divider plain style={{ width: "100%", fontSize: "20px" }} orientation="left" type="horizontal">
                        Le résultat
                    ...
                    <Alert
                    message="Article réel"
                    type="success"
                    description="Nous avons détecter que cet article contient des informations réels."
                    showIcon
                  />
                  ...
                  type="error"
                  description="Nous avons détecter que cet article contient des informations fausses."
                  showIcon
